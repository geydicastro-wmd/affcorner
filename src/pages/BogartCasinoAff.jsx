...
import BogartCasinoLogoLarge from "../assets/logo_brands/bogart_casino_logo.png";

export default function BogartCasinoAff() {
  return (
    <main className="affiliate-signup-page bogart bg-dark text-light">
        ...
        <Row className="align-items-center justify-content-between g-5">
          ...
          <Col lg={7} className="text-center text-lg-start order-1 order-lg-0">
            <span className="text-warning fw-bold text-uppercase small">
              Bogart Casino Affiliates
            </span>

            <h1 className="display-4 fw-bold mt-3 mb-4">
              Partner with a casino brand built to convert.
            </h1>

            <p className="lead text-light mb-5">
              Sign up for the Bogart Casino affiliate program and start promoting a
              competitive casino platform backed by trusted
              affiliate support.
            </p>

            <picture>
              <source media="(max-width: 991px)" srcSet={BogartCasinoLogoLarge} />
              <img
                src={BogartCasinoLogoLarge}
                alt="Bogart Casino"
              ...
              <Col md={4}>
                <div className="partner-benefit h-100 p-3 rounded-4">
                  ...
                  <p className="small text-light mb-0">
                    Promote a brand designed for casino traffic.
                  </p>
                </div>
              </Col>
          ...
          {/* Register */}
          <Col lg={5} className="order-0 order-lg-1 text-center">
          <picture>
              <img
                src={BogartCasinoLogoLarge}
                alt="Bogart Casino"
                className="img-fluid mb-3 d-lg-none"
                width="240"
                height="240"
              />
            </picture>
            <div className="signup-panel rounded-5 p-3 p-lg-4">
              ...
              <div className="signup-iframe-wrap rounded-4 bg-light">
                <iframe
                  title="Bogart Casino affiliate sign-up"
                  id="aff-signup"
                  src="https://original.cdncasino.ag/affsignup/index2.php?brand=bogartcasinoag&amp;brand_domain=bogartcasino.ag&amp;affiliate_version=2"
